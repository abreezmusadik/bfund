...
class RegistrationScreen extends StatefulWidget {
  ...
  final String? referrarCode;
  RegistrationScreen({Key? key, this.referrarCode}) : super(key: key);
...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  final ReferralEditingController = new TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    final confirmPasswordField = TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: EdgeInsets.fromLTRB(20, 15, 20, 15),
          hintText: "Confirm PhoneNumber",
          border: OutlineInputBorder(
            borderRadius: BorderRadius.circular(10),
          ),
        ));
    final ReferralField = TextFormField(
        autofocus: false,
        ...
        // },
        onSaved: (value) {
          ReferralEditingController.text = value!;
        },
        textInputAction: TextInputAction.next,
        decoration: InputDecoration(
          prefixIcon: Icon(Icons.account_circle),
